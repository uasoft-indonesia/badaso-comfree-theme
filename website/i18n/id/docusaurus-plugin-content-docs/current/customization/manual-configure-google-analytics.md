...
Alternatif konfigurasi ini digunakan ketika hit google analytics tidak berjalan pada badaso comfree theme 
...
```
4. Pada `resources/views` buat folder dengan nama `vendor/comfree-theme`
5. Salin file `vendor/badaso/comfree-theme/src/resources/views/app.blade.php` ke folder `resources/views/vendor/comfree-theme`
6. Memanggil `resources/views/partials/google-analytics.blade.php` pada `resources/views/vendor/comfree-theme/app.blade.php`
```
<!DOCTYPE html>
<html lang="en">
