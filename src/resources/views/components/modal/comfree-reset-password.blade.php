...
<div class="modal" id="modal_reset_password" role="dialog">
    <div class="modal-box">
        ...
        <form action="" x-data="fetchAuthenticated()" @submit.prevent="resetPassword()">
            <div class="flex flex-col w-full py-4">
                <div class="flex justify-center mt-3 relative">
                    <input :type="show ? 'password' : 'text'" placeholder="New Password"
                        class="input input-bordered input-sm w-full max-w-xs rounded" x-model="formResetPassword.password"
                        required />
                ...
                <div class="flex justify-center mt-3">
                    <input type="password" placeholder="Password Confirmation"
                        ...
                        x-model="formResetPassword.passwordConfirmation" required />
                </div>
