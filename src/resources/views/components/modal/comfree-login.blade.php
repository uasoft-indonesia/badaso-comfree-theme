...
<div class="modal" id="modal_login" role="dialog">
    <div class="modal-box">
            ...
            <div class="flex flex-col w-full py-4">
                ...
                <div class="flex w-full max-w-xs ml-[70px] mr-[70px] justify-between mt-1">
                    ...
                    <div class="flex items-center ">
                        <span class="label-text text-sky-400 text-xs cursor-pointer"
                            x-on:click="modalForgetPassword()">Forgot
                            password</span>
                    </div>
                </div>
        ...
        <div class="flex justify-center">
            <span class="text-xs">Don't have an account? <label for=""
                    class="text-sky-400 text-xs cursor-pointer" x-on:click="modalRegister()">Create an account</label>
            </span>
        </div>
    </div>
</div>
