...
<div class="modal" role="dialog" id="modal_register">
    <div class="modal-box">
                ...
                <div class="flex flex-col w-full py-4 space-y-3">
                    <div class="flex justify-center">
                        <input type="text" placeholder="Name"
                            class="input input-sm w-full max-w-xs rounded border-gray-300
                                    focus:border-gray-300"
                            x-model="formRegister.name" required />
        ...
        <div class="flex justify-center">
            <span class="text-xs">Do you have an account? <label for=""
                    class="text-sky-400 text-xs cursor-pointer" x-on:click="modalLogin()">Login</label> </span>
        </div>
    </div>
</div>
