  <div class="container mx-auto w-full max-w-[1150px]">
      <div class="flex mt-10 mx-4">
          <div class="carousel rounded gap-4 w-full">
              @foreach ($item_product as $key => $item)
                  <div class="carousel-item w-60 h-full">
                      <div
                          class="flex flex-col rounded cursor-pointer transition ease-in-out delay-150  hover:shadow-xl duration-400 border relative">
